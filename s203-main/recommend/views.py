...
# Definição da View para criar usuários
class CriarUsuariosView(View):
    def get(self, request):
        # Renderiza o formulário para criar um novo usuário
        return render(request, 'usuarios/criar_usuarios.html')
    ...
    def post(self, request):
        ...
        novo_usuario = UsuarioModel(nome=nome, senha=senha)
        novo_usuario.save()

        # Retorna uma resposta JSON confirmando a criação do usuário
